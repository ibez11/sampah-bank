...
@section('title')
  Penarikan Berhasil - Tuan Di Bangarna Bank
@endsection
...
<p style="font-family: sans-serif;font-size: 16px !important;font-weight: normal;margin: 0;margin-bottom: 15px;">Email ini merupakan pemberitahuan bahwa Anda telah sukses melakukan penarikan.</p>
<p style="font-family: sans-serif;font-size: 16px !important;font-weight: normal;margin: 0;margin-bottom: 15px;">Kamu baru saja menarik sejumlah:</p>
<ul class="highlight" style="font-family: sans-serif;font-size: 16px !important;font-weight: normal;margin: 0;margin-bottom: 15px;background: #efefef;padding: 20px;border-radius: 5px;">
  <li style="list-style: none;">Jumlah Penarikan: Rp. {{ number_format($amount_used, 2)  }}</li>
  <br/>
